...
pub(in crate::localization) mod error_code {
    pub(in crate::localization) const LOCALIZATION_NOT_CACHED: &str = "NB0201";
    pub(in crate::localization) const LOCALIZATION_PRODUCTION_SYNC: &str = "NB0202";
    pub(in crate::localization) const LOCALIZATION_DEV_SYNC: &str = "NB0203";
    pub(in crate::localization) const LOCALIZATION_CHECKSUM: &str = "NB0204";
}
