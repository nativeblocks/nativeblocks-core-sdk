...
pub(in crate::feature::frame) mod error_code {
    ...
    pub(in crate::feature::frame) const FRAME_DEV_SYNC: &str = "NB0103";
    pub(in crate::feature::frame) const FRAME_CHECKSUM: &str = "NB0105";
}

pub(in crate::feature::frame) mod message {
    pub(in crate::feature::frame) const FRAME_NOT_CACHED: &str =
