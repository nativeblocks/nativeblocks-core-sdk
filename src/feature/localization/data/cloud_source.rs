...
use crate::feature::localization::data::db_source;
use crate::feature::localization::data::dto::{
...
use crate::feature::localization::data::mapper;
use crate::feature::localization::data::query;
...
async fn fetch_production_checksum(
    ...
    let data: NativeLocalizationProductionChecksumDataDto =
        request(http, headers, transport.as_ref())
            .await
...
async fn request_localization(
    ...
    let data: NativeLocalizationDataDto = request(http, headers, transport.as_ref()).await?;
